  ...
  public:
    ...
    void processCommand(const String& command) {
      if (command == "clickslot") {
        ...
        clickSlotDe();
        moveAndClick(10, 4, 62, 1);
        delay(500);
        moveAndClick(10, 5, 53, 1);
        delay(500);
        ...
        moveAndClick(10, 1, 74, 1);
        delay(1000);
        moveAndClick(10, 2, 68, 1);
        delay(1000);
        ...
        moveAndClick(10, 3, 67, 1);
        // moveAndClick(10, 4, 62, 1);
        delay(1000);
        // moveAndClick(10, 4, 54, 1);
        // delay(1000);
        clickStart();
